...
import 'package:talabat_ordering_system/screens/details/details_screen.dart';
import 'package:talabat_ordering_system/screens/home/home_bloc.dart';
import 'package:talabat_ordering_system/utils/shared_widgets/buttomSheet.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  InkWell? cartView(BuildContext context) {
    return bloc.getListOfItemWithQtyMoreThanZero().length == 0
        ? null
        : InkWell(
            onTap: () async {
              await showOurCartModal(
                  context: context,
                  list: bloc.getListOfItemWithQtyMoreThanZero(),
                  onPressed: (value) {
                    print(value);
                    setState(() {});
                  },
            ...
            return Column(
              ...
              children: [
                ...
                bloc.mainList[index].items.length > 0
                    ? SizedBox(
                        height: bloc.mainList[index].items.length * 132,
                        child: ListView.builder(
